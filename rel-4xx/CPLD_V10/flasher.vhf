-- VHDL model created from C:\DocsForDan\CPLD\cpld\data\drawing\bufe8.sch - Thu Nov 18 09:30:10 2004
...
-- VHDL model created from C:\DocsForDan\CPLD\cpld\data\drawing\fd.sch - Thu Nov 18 09:30:10 2004
...
-- VHDL model created from C:\DocsForDan\CPLD\cpld\data\drawing\fdc.sch - Thu Nov 18 09:30:10 2004
...
-- VHDL model created from flasher.sch - Thu Nov 18 09:30:10 2004
...
begin
   ...
   XLXI_66 : process_1w
      port map (clock=>XLXN_415, D0=>data(0), D1=>data(1), D2=>data(2),
            ...
            reset=>XLXN_296, d4=>data(4), d5=>data(5), d6=>data(6), OneW=>OneW);
   ...
   XLXI_67 : process_norm
      port map (addr(5 downto 0)=>addr(5 downto 0), ID0=>ID0_DUMMY,
            ...
            DCDCEN=>DCDCEN, DCDCON=>DCDCON, DP(7 downto 0)=>DP(7 downto 0),
            ENMUXA=>ENMUXA, ENMUXB=>ENMUXB, ENMUXC=>ENMUXC, ENMUXF=>ENMUXF,
            L(11 downto 0)=>L(11 downto 0), LE_DP=>LE_DP, mux0=>MUX0,
            mux1=>MUX1, mux2=>MUX2, mux3=>MUX3, rd0111=>XLXN_425,
            rd1111=>XLXN_424, reset=>XLXN_296, SDMUX=>SDMUX, SEL_SPI=>selspi,
            SEL_1W=>XLXN_104, data(7 downto 0)=>data(7 downto 0));
   ...
   XLXI_160 : djw_spi
      port map (clock=>XLXN_415, data(7 downto 0)=>data(7 downto 0),
            reset=>XLXN_296, sel_spi=>selspi, wrn=>XLXN_428, csn=>nCS,
            dout=>MOSI, sclk=>SCLK);
