...
BEGIN SCHEMATIC
    ...
    BEGIN NETLIST
        ...
        BEGIN BLOCK XLXI_67 process_norm
            ...
            PIN rd1111 XLXN_424
            PIN rd0111 XLXN_425
            PIN pwr_reset PWR_RESET
            PIN pre_reset XLXN_296
        END BLOCK
    ...
    BEGIN SHEET 1 3520 2720
        ...
        END BRANCH
        BEGIN DISPLAY 3252 128 TEXT "CPLD V12"
            FONT 64 "Arial"
        END DISPLAY
        ...
        BEGIN BRANCH PWR_RESET
            WIRE 1952 944 2272 944
            WIRE 2272 944 2576 944
            WIRE 2272 736 2272 944
        END BRANCH
        IOMARKER 1952 944 PWR_RESET R180 28
        INSTANCE XLXI_169 2208 736 R0
        BEGIN BRANCH XLXN_296
            WIRE 1952 512 2432 512
            WIRE 2432 512 2432 1024
            WIRE 2432 1024 2576 1024
        END BRANCH
        BEGIN BRANCH XLXN_431
