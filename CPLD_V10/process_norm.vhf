-- VHDL model created from C:\DocsForDan\CPLD\cpld\data\drawing\bufe8.sch - Thu Nov 18 09:30:13 2004
...
-- VHDL model created from process_norm.sch - Thu Nov 18 09:30:14 2004
...
begin
   ...
   XLXI_2 : register_o
      port map (data(7 downto 0)=>data(7 downto 0), nwr=>nwr,
            reset=>reset_DUMMY, sel_dcdc_ctrl=>XLXN_551,
            sel_delay_adjust=>XLXN_533, sel_LEDEN4_1=>XLXN_528,
            sel_LEDEN8_5=>XLXN_529, sel_LEDEN12_9=>XLXN_530,
   ...
   XLXI_42 : AND2B1
      port map (I0=>nwr, I1=>XLXN_538, O=>reset_DUMMY);
